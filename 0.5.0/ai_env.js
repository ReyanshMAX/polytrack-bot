...
function initAI() {
    if (typeof callSharedEventListener === 'undefined' || typeof getShared === 'undefined') {
        setTimeout(initAI, 100);
        return;
    }
    postToWorker = callSharedEventListener("postToWorker");
    Q_ = getShared("Q_");
    if (!Q_) { setTimeout(initAI, 100); return; }
    console.log("AI: game functions ready, initializing...");
    setupAI();
}
setTimeout(initAI, 100);
